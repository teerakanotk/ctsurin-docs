...
- ไปที่ Network and Internet
   ...
   ![technitium-zone-1](/images/technitium/technitium-zone-1.png)

- คลิก Network and Internet

   ![technitium-zone-2](/images/technitium/technitium-zone-2.png)

- ที่แถบด้านซ้าย คลิก Change adapter settings

   ![technitium-zone-3](/images/technitium/technitium-zone-3.png)

- เลือก Network Adapter ที่เชื่อมต่อกับเครือข่ายเดียวกับ DNS Server

   ![technitium-zone-4](/images/technitium/technitium-zone-4.png)

- คลิกขวาและเลือก Properties

   ![technitium-zone-5](/images/technitium/technitium-zone-5.png)

- เลือก Internet Protocol Version 4 (TCP/IPv4) และคลิกปุ่ม Properties

   ![technitium-zone-6](/images/technitium/technitium-zone-6.png)

- เลือก Use the following DNS server addresses และกำหนดค่า DNS ดังนี้

   - Preferred DNS server: ใส่ IP Address ของ DNS Server หลัก

   - Alternate DNS server: ใส่ IP Address ของ DNS Server สำรอง (ถ้ามี)

   ![technitium-zone-7](/images/technitium/technitium-zone-7.png)

- คลิกปุ่ม OK และ OK อีกครั้งเพื่อบันทึก
...
หากผลลัพธ์ที่ได้คล้ายกับตัวอย่าง แสดงว่าตั้งค่าถูกต้อง
...
1. เปลี่ยน DNS Server ที่ใช้ในการค้นหา โดยใช้คำสั่ง `server <ip_address>` แทน
...
2. จากนั้นใช้คำสั่ง `server <nameserver>` อีกครั้ง
