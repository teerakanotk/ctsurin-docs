...
# การสร้าง LXC Container

ในการสร้าง LXC Container บน Proxmox VE คุณสามารถทำได้ตามขั้นตอนดังนี้:
...
- ในเมนูด้านซ้าย เลือก **Datacenter** > **Nodes** และเลือก Node ที่คุณต้องการสร้าง LXC Container
